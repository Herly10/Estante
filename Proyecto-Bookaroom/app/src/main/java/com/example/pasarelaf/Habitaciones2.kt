...
class Habitaciones2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_habitaciones2)
    ...
    fun usuariohabit2(view: View){
        val ushabit2 = Intent(this,Perfil::class.java)
        startActivity(ushabit2)
    }
}
